        ...
        <div className={styles.advantagesGrid}>
          <div className={styles.advantage}>
            <div className={styles.advantageIcon}>
              <Image src="/images/masters.svg" alt="Опытные мастера" width={60} height={60} />
            </div>
          ...
          <div className={styles.advantage}>
            <div className={styles.advantageIcon}>
              <Image src="/images/equipment.svg" alt="Современное оборудование" width={60} height={60} />
            </div>
          ...
          <div className={styles.advantage}>
            <div className={styles.advantageIcon}>
              <Image src="/images/guarantee.svg" alt="Гарантия качества" width={60} height={60} />
            </div>
          ...
          <div className={styles.advantage}>
            <div className={styles.advantageIcon}>
              <Image src="/images/price.svg" alt="Доступные цены" width={60} height={60} />
            </div>
